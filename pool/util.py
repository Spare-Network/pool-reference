...
from spare.protocols.pool_protocol import PoolErrorCode, ErrorResponse
...
class RequestMetadata:
    ...
    query: Dict[str, str]  # query params passed in the url. These are not used by spare clients at the moment, but
